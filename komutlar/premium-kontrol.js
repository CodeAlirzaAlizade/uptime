    ...
    async execute(client, interaction) {   
      ...
      interaction.reply({embeds: [PremiumAktif]}) 
        ...
        const PremiumVar = new EmbedBuilder()
         .setColor("Green")
         .setDescription(`✅ **Premium üyeliğiniz bulunmaktadır. Premiumun bitişine kalan zaman:** Süresiz`)
      ...
      const PremiumDeaktif = new EmbedBuilder()
         .setColor("Red")
         .setDescription(`❌ **Premium üyeliğiniz bulunmamaktadır, Premium üyelik almak için destek sunucusuna gelebilirsiniz.**`)
